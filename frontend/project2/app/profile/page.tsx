...
export default function ProfilePage() {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://52.78.27.224.nip.io/api/v1/members/profile/images/upload",
        {
          method: "POST",
          body: formData,
          credentials: "include",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://52.78.27.224.nip.io/api/v1/members/${profile.memberId}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDeleteAccount = async () => {
    try {
      ...
      // 계정 삭제 API 호출
      const response = await fetch(
        `https://52.78.27.224.nip.io/api/v1/members/delete`,
        {
          method: "DELETE",
          credentials: "include",
        }
